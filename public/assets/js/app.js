...
const displayCV = () => {
    ...
    const displayData = (templateElements) => {
        ...
        populateList(experiences, userInputs.experiences, (experience) => `<div><strong>${experience.title}</strong> ${experience.organization} ${experience.start_date} - ${experience.end_date} ${experience.location}<br>${experience.description}</div>`);
    }
